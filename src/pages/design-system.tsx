  ...
  return (
    <PageContainer>
      <Section>
        ...
        <IntroText>
          A comprehensive design system for the retro-themed resume website, inspired by 1950s-1970s product design.
        </IntroText>
      </Section>
      ...
      <Section>
        ...
        <ColorGrid>
          <ColorCard bgColor={colors.primary.base} textColor={colors.white}>
            <ColorName>Primary</ColorName>
            <ColorValue>{colors.primary.base}</ColorValue>
          </ColorCard>
          <ColorCard bgColor={colors.primary.hover} textColor={colors.white}>
            <ColorName>Primary Hover</ColorName>
            <ColorValue>{colors.primary.hover}</ColorValue>
          </ColorCard>
          <ColorCard bgColor={colors.primary.light} textColor={colors.text.primary}>
            <ColorName>Primary Light</ColorName>
            <ColorValue>{colors.primary.light}</ColorValue>
          </ColorCard>
          <ColorCard bgColor={colors.primary.dark} textColor={colors.white}>
        ...
        <ColorGrid>
          <ColorCard bgColor={colors.secondary.base} textColor={colors.white}>
            <ColorName>Secondary</ColorName>
            <ColorValue>{colors.secondary.base}</ColorValue>
          </ColorCard>
          <ColorCard bgColor={colors.tertiary.base} textColor={colors.text.primary}>
            <ColorName>Tertiary</ColorName>
            <ColorValue>{colors.tertiary.base}</ColorValue>
          </ColorCard>
          <ColorCard bgColor={colors.accent.base} textColor={colors.text.primary}>
            <ColorName>Accent</ColorName>
            <ColorValue>{colors.accent.base}</ColorValue>
          </ColorCard>
          <ColorCard bgColor={colors.coral.base} textColor={colors.white}>
        ...
        <ColorGrid>
          <ColorCard bgColor={colors.cream.base} textColor={colors.text.primary}>
            <ColorName>Cream</ColorName>
            <ColorValue>{colors.cream.base}</ColorValue>
          </ColorCard>
          <ColorCard bgColor={colors.text.primary} textColor={colors.white}>
            <ColorName>Text Primary</ColorName>
            <ColorValue>{colors.text.primary}</ColorValue>
          </ColorCard>
          <ColorCard bgColor={colors.text.secondary} textColor={colors.white}>
            <ColorName>Text Secondary</ColorName>
            <ColorValue>{colors.text.secondary}</ColorValue>
          </ColorCard>
          <WhiteColorCard bgColor={colors.white} textColor={colors.text.primary}>
      ...
      <Section>
        ...
        <BodyFontExample>
          Body Font (Comfortaa) - Used for body text and readable content
        </BodyFontExample>
        ...
        <TypographyExample>
          <BodyTextExample>
            Body text - Used for paragraphs and main content. Comfortaa font provides excellent readability.
          </BodyTextExample>
        </TypographyExample>
        <TypographyExample>
          <BodyLargeExample>
        ...
        <TypographyExample>
          <BodySmallExample>
            Small body text - For captions, labels, or secondary information.
          </BodySmallExample>
        </TypographyExample>
      </Section>
      ...
      <Section>
        ...
        <BorderRadiusGrid>
          {Object.entries(borders.radius).slice(0, 8).map(([key, value]) => (
